...
@freezed
abstract class LougaRemoteNotification with _$LougaRemoteNotification {
  ...
  factory LougaRemoteNotification.fromMap(Map<String, dynamic> message) {
    final isBackground = bool.parse((message['is_background'] as String?) ?? 'true');
    final configJSONString = message['config'];
    final config =
        configJSONString != null ? jsonDecode(configJSONString as String) as Map<String, dynamic> : <String, dynamic>{};
