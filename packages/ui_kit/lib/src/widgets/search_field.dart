...
class _SearchFieldState extends State<SearchField> {
  ...
  void initState() {
    ...
    _debouncer = Debouncer(
      delay: Duration(milliseconds: widget.delayInMilliSeconds),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: TextField(
        style: frogTheme.textStyles.titleMedium.copyWith(
          color: frogTheme.colors.neutral10,
        ),
        ...
        decoration: InputDecoration(
          ...
          hintStyle: frogTheme.textStyles.titleMedium.copyWith(
            color: FrogTheme.of(context).colors.neutral50,
          ),
